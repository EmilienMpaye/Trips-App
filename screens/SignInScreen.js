    ...
    <ScreenWrapper>
      <View className="flex justify-between h-full mx-4">
        <View >
            ...
            <Text className={`${colors.heading}text-xl font-bold text-center text-green-600`}>Sign In</Text>
            </View>
      
      <View className="flex-row justify-center my-3 mt-5">
       <Image className="h-72 w-72" source={require('../assets/login.jpeg')}/>
        </View>
     ...
     <View>
      {
        userLoading?(
          ...
          <Text className="text-lg text-yellow-300 font-bold">Sig In</Text>
            </TouchableOpacity>
        )
      }
